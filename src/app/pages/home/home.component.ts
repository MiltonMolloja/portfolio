  ...
  template: `
      ...
      <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <!-- E-Commerce Buttons Group -->
            <div class="flex flex-wrap gap-4 mb-8">
              <div class="flex items-center gap-2 px-4 py-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                <!-- Label -->
                <span class="text-base text-gray-300 font-semibold flex items-center gap-2 mr-2">
                ...
                <div class="flex items-center">
                  ...
                  <a
                    ...
                    class="inline-flex items-center px-3 py-1.5 rounded-l-md font-medium text-sm bg-emerald-600 text-white hover:bg-emerald-500 transition-all"
                    title="Ver E-Commerce en Producción">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center px-3 py-1.5 rounded-r-md font-medium text-sm bg-orange-500 text-white hover:bg-orange-400 transition-all"
                    title="Ver E-Commerce en Desarrollo">
                    <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="p-2 rounded-lg text-gray-600 dark:text-gray-500 hover:text-green-600 dark:hover:text-green-400 hover:bg-gray-200 dark:hover:bg-slate-800 transition-colors"
                aria-label="WhatsApp"
              >
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 bg-gray-50 dark:bg-[#0f172a]">
      <div class="container-custom">
        ...
        <div class="text-center">
          <a routerLink="/skills" class="inline-flex items-center px-6 py-3 rounded-full font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white border border-gray-300 dark:border-[#334155] hover:border-gray-400 dark:hover:border-[#475569] transition-all">
