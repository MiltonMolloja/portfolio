      ...
      <div class="p-6 flex flex-col flex-1">
        ...
        <div class="flex flex-wrap gap-1.5 mb-4">
          ...
          @if (project.techStack.length > 4) {
            <span class="text-xs px-2 py-1 rounded bg-gray-100 dark:bg-dark-bg text-gray-500 dark:text-gray-500">
        ...
        @if (project.metrics.length > 0) {
          <div class="flex gap-4 mb-4 pb-4 border-b border-gray-100 dark:border-dark-border">
            @for (metric of project.metrics.slice(0, 2); track metric.label) {
              <div>
          ...
          @if (project.demoUrl) {
            @if (project.id === 'ecommerce-platform') {
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                class="p-1.5 rounded text-emerald-500 hover:text-emerald-400 transition-colors"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                class="p-1.5 rounded text-orange-500 hover:text-orange-400 transition-colors"
